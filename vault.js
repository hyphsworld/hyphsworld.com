document.addEventListener("DOMContentLoaded", () => {
  ...
  function unlockVault() {
    ...
    if (entered === MAIN_CODE) {
      ...
      showLevel(1);
      trackVault("vault_main_access", { trigger: "code_entry" });
      return;
    }
    ...
    if (entered === ELITE_CODE) {
      ...
      showLevel(2);
      trackVault("vault_elite_access", { trigger: "code_entry" });
      return;
    }
  ...
  if (urlCode === MAIN_CODE) {
    setAccess("main");
    showLevel(1);
    trackVault("vault_main_access", { trigger: "url_code" });
  } else if (urlCode === ELITE_CODE) {
    setAccess("elite");
    showLevel(2);
    trackVault("vault_elite_access", { trigger: "url_code" });
  } else {
