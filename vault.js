...
function handleCode(raw) {
  ...
  if (!code) {
    showMessage("Type a code first. Buck not moving until he sees letters.");
    return;
  }
  ...
  if (mainCodes.includes(code)) {
    ...
    savePoints(100);
    showMessage("JACKPOT. Main room open. Level 1 and Level 2 unlocked.");
  ...
  savePoints(1);
  showMessage("No hit. Duck Sauce said that code got declined at the cage.");
