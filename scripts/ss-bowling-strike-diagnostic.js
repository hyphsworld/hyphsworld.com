...
assert(publisher.includes("grep -q 'bowling-effects.js?v=179' site/games/ss-bowling/game.html"), 'Publisher must verify the game loads the restored effect');
...
assert(effects.includes('hw-gator-water'), 'Alley Gator eyes must emerge from a water-like lane surface');
...
assert(game.includes('bowling-effects.js?v=179'), 'Bowling page must cache-bust the corrected effects file for mobile Safari');
