...
(() => {
  ...
  const REWARDS = [
    ...
    { key: "slots_50", game: "slots", threshold: 50, tier: "Silver", title: "Hidden Track Clue", detail: "Slots progress hit 50. Hidden track clue unlocked." },
    { key: "slots_100", game: "slots", threshold: 100, tier: "Gold", title: "Slot Vault Token", detail: "Slots progress hit 100. Casino token clue unlocked." },
    ...
    { key: "blackjack_50", game: "blackjack", threshold: 50, tier: "Silver", title: "Blackjack Backroom Code", detail: "Blackjack progress hit 50. Backroom code clue unlocked." },
    { key: "blackjack_100", game: "blackjack", threshold: 100, tier: "Gold", title: "Backroom Invite", detail: "Blackjack progress hit 100. Backroom invite progress unlocked." },
    { key: "wheel_25", game: "wheel", threshold: 25, tier: "Bronze", title: "Wheel Signal", detail: "Wheel progress hit 25. Bonus signal unlocked." },
    { key: "wheel_50", game: "wheel", threshold: 50, tier: "Silver", title: "Vault Wheel Bonus", detail: "Wheel progress hit 50. Bonus clue unlocked." },
    { key: "wheel_100", game: "wheel", threshold: 100, tier: "Gold", title: "Portal Spin Key", detail: "Wheel progress hit 100. Portal key clue unlocked." },
    ...
    { key: "casino_250", game: "total", threshold: 250, tier: "Platinum", title: "Underground Pass", detail: "Total casino bank hit 250. Underground pass progress unlocked." },
    { key: "casino_500", game: "total", threshold: 500, tier: "Diamond", title: "Duck Sauce VIP Signal", detail: "Total casino bank hit 500. VIP signal unlocked." }
  ];
