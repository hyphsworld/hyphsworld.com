-- Correct PostgreSQL function qualification in PR #170's game submission RPC.
-- Production project yuhxtdkhsltaqiagrtys received this recovery immediately after the original migration.
